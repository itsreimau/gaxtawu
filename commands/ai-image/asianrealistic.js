...
module.exports = {
    ...
    code: async (ctx) => {
        ...
        if (!input) return await ctx.reply(
            ...
            `${formatter.quote(tools.msg.generateCmdExample(ctx.used, "evangelion anime girl with short blue hair"))}\n` +
        ...
        try {
            const apiUrl = tools.api.createUrl("neko", "/ai-img/asian-realistic", {
                text: input
            });
