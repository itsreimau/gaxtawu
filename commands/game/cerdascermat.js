	...
	code: async (ctx) => {
		...
		try {
			...
			const game = {
				...
				answer: result.semua_jawaban
					.find((obj) => Object.keys(obj)[0] === result.jawaban_benar)
					[result.jawaban_benar].toLowerCase(),
			};
