module.exports = {
    ...
    code: async (ctx) => {
        ...
        if (accountId === config.bot._lid) return await ctx.reply(formatter.quote(`❎ Ketik ${formatter.inlineCode(`${ctx.used.prefix + ctx.used.command} bot`)} untuk me-unmute bot.`));
