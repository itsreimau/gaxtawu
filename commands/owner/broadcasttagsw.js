...
module.exports = {
    ...
    code: async (ctx) => {
        ...
        try {
            ...
            const waitMsg = await ctx.reply(formatter.quote(`🔄 Mengirim siaran ke ${groupIds.length} grup, perkiraan waktu: ${tools.msg.convertMsToDuration(groupIds.length * 0.5 * 1000)}`));
